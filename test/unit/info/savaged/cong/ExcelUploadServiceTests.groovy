...
class ExcelUploadServiceTests extends GrailsUnitTestCase {
    ...
    protected void setUp() {
        ...
        def members = [
            ...
            new Member(lastname:'Savage', firstname:'Gaile', birth:df.parse('1963-01-09'), isMale:false, isPublisher:true, groupUnit:Groups.PENFIELDS_HOUSE, immersion:df.parse('1990-09-23'), isRegularPioneer:true),
